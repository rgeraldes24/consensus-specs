...
from zond2spec.test.helpers.inactivity_scores import (
...
from zond2spec.test.helpers.sharding import (
...
def random_block_capella(spec, state, signed_blocks, scenario_state, rng=Random(3456)):
    ...
    block.body.dilithium_to_execution_changes = get_random_bls_to_execution_changes(
        spec,
        state,
