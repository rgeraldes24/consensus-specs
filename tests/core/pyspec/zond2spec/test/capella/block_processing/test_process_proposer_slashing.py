from zond2spec.test.context import spec_state_test, expect_assertion_error, always_bls, with_all_phases
from zond2spec.test.helpers.block import build_empty_block_for_next_slot
from zond2spec.test.helpers.block_header import sign_block_header
from zond2spec.test.helpers.keys import privkeys
from zond2spec.test.helpers.proposer_slashings import get_valid_proposer_slashing, check_proposer_slashing_effect
from zond2spec.test.helpers.state import next_epoch
