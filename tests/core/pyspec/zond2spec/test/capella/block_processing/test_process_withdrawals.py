...
from zond2spec.test.helpers.constants import MAINNET, MINIMAL
from zond2spec.test.helpers.execution_payload import (
    build_empty_execution_payload,
    compute_el_block_hash,
)
from zond2spec.test.helpers.random import (
    randomize_state,
)
...
from zond2spec.test.helpers.withdrawals import (
    prepare_expected_withdrawals,
    set_zond1_withdrawal_credential_with_balance,
...
def test_success_no_max_effective_balance(spec, state):
    ...
    set_zond1_withdrawal_credential_with_balance(spec, state, validator_index, spec.MAX_EFFECTIVE_BALANCE - 1)
...
def test_success_no_excess_balance(spec, state):
    ...
    set_zond1_withdrawal_credential_with_balance(spec, state, validator_index, spec.MAX_EFFECTIVE_BALANCE)
    validator = state.validators[validator_index]
