...
from zond2spec.test.context import expect_assertion_error
from zond2spec.test.helpers.keys import pubkeys, privkeys
from zond2spec.test.helpers.state import get_balance
from zond2spec.utils import bls
from zond2spec.utils.merkle_minimal import calc_merkle_tree_from_leaves, get_merkle_proof
from zond2spec.utils.ssz.ssz_impl import hash_tree_root
from zond2spec.utils.ssz.ssz_typing import List
...
def prepare_state_and_deposit(spec, state, validator_index, amount,
    ...
    state.zond1_deposit_index = 0
    state.zond1_data.deposit_root = root
    state.zond1_data.deposit_count = len(deposit_data_list)
    return deposit
...
def run_deposit_processing(spec, state, deposit, validator_index, valid=True, effective=True):
    ...
    assert state.zond1_deposit_index == state.zond1_data.deposit_count
...
def run_deposit_processing_with_specific_fork_version(
    ...
    state.zond1_deposit_index = 0
    state.zond1_data.deposit_root = root
    state.zond1_data.deposit_count = 1
