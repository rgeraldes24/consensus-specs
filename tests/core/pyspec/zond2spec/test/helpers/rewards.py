...
from zond2spec.phase0.mainnet import VALIDATOR_REGISTRY_LIMIT  # equal everywhere, fine to import
...
from zond2spec.utils.ssz.ssz_typing import Container, uint64, List
