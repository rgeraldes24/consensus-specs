...
from zond2spec.test.helpers.keys import privkeys, pubkeys
from zond2spec.test.helpers.state import (
    state_transition_and_sign_block,
)
from zond2spec.test.helpers.block import (
    build_empty_block_for_next_slot,
)
from zond2spec.test.helpers.sync_committee import (
    compute_committee_indices,
    compute_aggregate_sync_committee_signature,
)
from zond2spec.test.helpers.proposer_slashings import get_valid_proposer_slashing
from zond2spec.test.helpers.attester_slashings import get_valid_attester_slashing_by_indices
from zond2spec.test.helpers.attestations import get_valid_attestation
from zond2spec.test.helpers.deposits import build_deposit, deposit_from_context
from zond2spec.test.helpers.voluntary_exits import prepare_signed_exits
from zond2spec.test.helpers.bls_to_execution_changes import get_signed_address_change
...
def prepare_state_and_get_random_deposits(spec, state, rng, num_deposits=None):
    ...
    state.zond1_data.deposit_root = root
    state.zond1_data.deposit_count += len(deposits)
    return deposits
