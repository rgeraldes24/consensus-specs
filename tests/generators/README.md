...
Any issues with the generators and/or generated tests should be filed in the repository that hosts the generator outputs,
 here: [rgeraldes24/consensus-spec-tests](https://github.com/rgeraldes24/consensus-spec-tests).
...
```python
from zond2spec.phase0 import spec as spec
from eth_utils import to_tuple
from zondspec.gen_helpers.gen_base import gen_runner, gen_typing
...
```python
from zond2spec.phase0 import spec as spec_phase0
from zond2spec.altair import spec as spec_altair
from zond2spec.test.helpers.constants import PHASE0, ALTAIR
...
if __name__ == "__main__":
    phase_0_mods = {key: 'zond2spec.test.phase0.sanity.test_' + key for key in [
        'blocks',
        'slots',
    ]}
    altair_mods = {**{key: 'zond2spec.test.altair.sanity.test_' + key for key in [
        'blocks',
...
- See [`tests/core/gen_helpers/README.md`](../core/pyspec/zond2spec/gen_helpers/README.md) for command line options for generators.
...
2. Remove the generated tests in the [`consensus-spec-tests`](https://github.com/rgeraldes24/consensus-spec-tests) repository by opening a pull request there.
